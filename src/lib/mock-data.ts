...
export const MOCK_APPLICATIONS: MockApplication[] = [
  ...
  },
  {
    ...
    applicant: { name: 'Gita Barla', email: 'gita@demo.com', tribe: 'Oraon', state: 'Jharkhand', category: 'ST' },
    schemeCode: 'NFST',
    schemeName: 'National Fellowship for Scheduled Tribes',
    status: ApplicationStatus.SCRUTINY_COMPLETE,
    currentStage: 'Screening',
  ...
  {
    id: 'app-00017',
    applicationNumber: 'NOS-2026-00017',
    applicant: { name: 'Anil Bhagat', email: 'anil@demo.com', tribe: 'Munda', state: 'Jharkhand', category: 'ST' },
    schemeCode: 'NOS',
    schemeName: 'National Overseas Scholarship',
    status: ApplicationStatus.UNDER_SCREENING,
    currentStage: 'Selection',
  ...
  {
    id: 'app-00018',
    applicationNumber: 'NFST-2026-00018',
    applicant: { name: 'Rekha Munda', email: 'rekha@demo.com', tribe: 'Munda', state: 'Odisha', category: 'ST' },
    schemeCode: 'NFST',
    schemeName: 'National Fellowship for Scheduled Tribes',
    status: ApplicationStatus.SCRUTINY_COMPLETE,
    currentStage: 'Screening',
    submittedAt: '2026-09-01T15:40:00Z',
    createdAt: '2026-08-30T09:00:00Z',
  },
  {
    id: 'app-00019',
    applicationNumber: 'NOS-2026-00019',
    applicant: { name: 'Suresh Oraon', email: 'suresh@demo.com', tribe: 'Oraon', state: 'Chhattisgarh', category: 'ST' },
    schemeCode: 'NOS',
    schemeName: 'National Overseas Scholarship',
    status: ApplicationStatus.UNDER_SCREENING,
    currentStage: 'Selection',
    submittedAt: '2026-09-01T10:25:00Z',
